...
def transform_data(oportunidades, sellout, **kwargs):
    """
...
def load_data(oportunidades, sellout, **kwargs):
    """
...
with DAG(
    dag_id='etl_airflow_pipeline',  
    description='ETL pipeline utilizando Airflow', 
    schedule='@daily',  # Usando 'schedule' no lugar de 'schedule_interval'
